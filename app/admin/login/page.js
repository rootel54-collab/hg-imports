...
export default function Login(){
 ...
 const go=async ev=>{ev.preventDefault();const {error}=await sb().auth.signInWithPassword({email:e,password:p});if(error)return setM('E-mail ou senha incorretos.');location.href='/admin'}
